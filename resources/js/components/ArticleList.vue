        ...
        <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/3" v-for="article in articles" :key="article.id">
            ...
            <article class="overflow-hidden rounded-lg shadow-lg" >
                ...
                <footer class="flex items-center justify-between leading-none p-2 md:p-4">
                    ...
                    <router-link :to="{ name: 'ModifierArticle', params: { id: article.id }}" class="text-blue-600 hover:underline"><button type="button" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Detail</button></router-link>    
                </footer>
            </article>
            <!-- END Article -->
